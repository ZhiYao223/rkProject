...
void action_took_mark(lv_event_t * e)
{
    ...
    if (!bInAutoTake){
        ...
        lv_obj_set_style_bg_color(objects.btn_mark_take_cw, lv_palette_main(LV_PALETTE_RED), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    } else  //如果已经在自动取灰状态：
    {
        ...
        lv_obj_set_style_bg_color(objects.btn_mark_take_cw, lv_palette_main(LV_PALETTE_BLUE), LV_PART_MAIN | LV_STATE_DEFAULT);
